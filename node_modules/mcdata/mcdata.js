...
/*
    const fs = require('fs'),
        ...
        download('http://s.optifine.net/capes/' + nickname + '.png', './files/cape0.png');

        
        const sharp = require('sharp');

          sharp('http://s.optifine.net/capes/' + nickname + '.png')
            .extract({left: 85, top: 106, width: 20, height: 31})
            .toFile('./files/cape0.png', function(err) {
              console.log("Error wile resizing the file.")
            });
*/
    ...
    return {
      ...
      skin: {
        ...
        headright: `https://mc-heads.net/head/${uuid}/right`,
        headleft: `https://mc-heads.net/head/${uuid}/left`,
        body: `https://mc-heads.net/body/${uuid}/right`,
        texture: `https://www.minecraft.net/en-us/profile/skin/remote%3Furl%3Dhttps%3A//visage.surgeplay.com/skin/${uuid}`,
        cape: `http://s.optifine.net/capes/${nickname}.png`,
      }
    };
  },
  /**
